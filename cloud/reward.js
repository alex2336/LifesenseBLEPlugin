...
exports.index = function (req, res) {
	...
	if (!currentUser) {
		...
		query.include('category.defaultReward');
		query.find({
			success:function(rewards){
				...
				rewards.forEach(function(reward){
					...
					if(category!="all"&&typeof category!="undefined"&&reward.categoryId==category){
						console.log(JSON.stringify(reward.get('category').get('defaultReward')));
						if(typeof reward.get('category').get('defaultReward')!='undefined'){
