...
@interface BodyInformation : NSObject

@property (nonatomic, assign) double fatRatio;  //Percentage
@property (nonatomic, assign) double waterContent; //Percentage
@property (nonatomic, assign) double mus; //Percentage
@property (nonatomic, assign) double boneQuality;//the unit is Kg
@property (nonatomic, assign) double metabolism;  //the  unit is Calorie
